...
export function TicketContinueBar({
  ...
  return (
    <button
      ...
      className="flex min-h-12 w-full items-center justify-center gap-2.5 rounded-[16px] bg-[#1e9bf0] px-4 py-3.5 text-[0.95rem] font-medium text-white transition-all hover:bg-[#1787da] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:bg-sky-400/70"
    >
      {isLoading ? (
